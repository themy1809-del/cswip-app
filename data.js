...
{vi:"Vai trò & nhiệm vụ Thanh tra Hàn", en:"Duties of the Welding Inspector",
 ...
 deep:[
  {h_vi:"Quyền hạn và giới hạn của thanh tra — vì sao tách bạch",h_en:"The inspector's authority and its limits — why the separation",
   body:[
    {vi:"Thanh tra hàn có quyền kiểm tra, chấp nhận hoặc loại bỏ theo tiêu chuẩn áp dụng, nhưng KHÔNG tự sửa mối hàn, KHÔNG tự cho nhân nhượng (concession), và KHÔNG làm việc theo tiêu chuẩn cá nhân ưa thích. Sự tách bạch này không phải hình thức: nếu người kiểm tra đồng thời là người sửa, tính độc lập mất đi và xung đột lợi ích phát sinh. Quyền nhân nhượng thuộc về khách hàng/bên thiết kế vì chỉ họ nắm điều kiện làm việc và hệ quả an toàn của việc chấp nhận một sai lệch. Thanh tra là 'con mắt' độc lập của khách hàng tại xưởng, và giá trị nghề nghiệp nằm chính ở sự khách quan đó.",en:"The welding inspector may inspect, accept or reject against the applicable standard, but does NOT repair welds, does NOT grant concessions, and does NOT work to a personally preferred standard. This separation is not a formality: if the person who inspects also repairs, independence is lost and a conflict of interest appears. The power to concede belongs to the client/design authority because only they hold the service conditions and the safety consequences of accepting a deviation. The inspector is the client's independent 'eyes' in the shop, and the professional value lies in that objectivity."},
    {vi:"QA và QC là hai tầng của cùng một mục tiêu chất lượng. QA (đảm bảo) là HỆ THỐNG phòng ngừa: quy trình, WPS, đào tạo, audit, kế hoạch ITP — đặt ra để lỗi KHÔNG xảy ra. QC (kiểm soát) là hoạt động PHÁT HIỆN: đo đạc, thử, NDT, kiểm tra ngoại quan — bắt lỗi khi đã xảy ra. Thanh tra hàn thuộc QC nhưng phải hiểu QA để biết mình đang kiểm mắt xích nào. ITP biến hệ thống này thành hành động: mỗi bước ghi rõ mức can thiệp H/W/R/M, và điểm dừng (hold point) là ràng buộc hợp đồng — vượt qua khi chưa được ký là vi phạm nghiêm trọng vì nó phá vỡ chuỗi kiểm soát.",en:"QA and QC are two layers of the same quality goal. QA (assurance) is the preventive SYSTEM: procedures, WPS, training, audits, the ITP — set up so defects do NOT happen. QC (control) is the DETECTION activity: measuring, testing, NDT, visual inspection — catching defects once they occur. The welding inspector sits in QC but must understand QA to know which link is being checked. The ITP turns the system into action: each step states its intervention level H/W/R/M, and a hold point is contractually binding — passing it unsigned is a serious violation because it breaks the control chain."},
    {vi:"Khung 'trước — trong — sau khi hàn' thực chất là quản trị rủi ro theo chi phí. Lỗi phát hiện TRƯỚC khi hàn (sai WPS, sai vật liệu, vát mép/khe hở sai, thợ chưa chứng nhận) sửa gần như miễn phí; lỗi để lọt tới SAU khi hàn (nứt, thiếu ngấu phát hiện bằng NDT) tốn kém gấp nhiều lần vì phải đục, hàn lại, NDT lại, và có thể đã lắp ráp. Vì nhiều bước không thể đảo ngược (hàn phủ lên rồi thì không còn thấy chân mối hàn), thanh tra ưu tiên kiểm tra ở thời điểm còn can thiệp được — đó là lý do đặt hold point ĐÚNG CHỖ quan trọng hơn là kiểm tra thật nhiều.",en:"The 'before — during — after welding' framework is really cost-based risk management. A defect caught BEFORE welding (wrong WPS, wrong material, bad prep/gap, unqualified welder) costs almost nothing to fix; one that slips through to AFTER welding (a crack or lack of fusion found by NDT) costs many times more — gouging, re-welding, re-NDT, possibly after assembly. Because many steps are irreversible (once capped, the root can no longer be seen), the inspector prioritises checks while intervention is still possible — which is why placing hold points in the RIGHT places matters more than inspecting a great deal."},
    {vi:"Hồ sơ và truy xuất là 'bộ nhớ pháp lý' của dự án. Báo cáo phải ghi SỰ THẬT quan sát được (hạng mục, tiêu chuẩn, dụng cụ đo, kết quả, đạt/không đạt, ngày, chữ ký) — không suy diễn. Truy xuất vật liệu (đối chiếu heat number với chứng chỉ EN 10204 3.1) đảm bảo đúng vật liệu được dùng; khi có sự cố nhiều năm sau, hồ sơ là thứ bảo vệ nhà thầu. Cuối cùng là đạo đức: thanh tra thường chịu áp lực 'cho qua' để kịp tiến độ; giữ trung thực dưới áp lực chính là phẩm chất cốt lõi của nghề, vì một chữ ký sai có thể dẫn tới phá hủy và thương vong.",en:"Records and traceability are the project's 'legal memory'. A report must state the FACTS observed (item, standard, gauges used, result, accept/reject, date, signature) — never opinion. Material traceability (matching heat numbers to an EN 10204 3.1 certificate) proves the correct material was used; if a failure occurs years later, the records are what protect the contractor. Finally, ethics: inspectors are often pressured to 'pass it' to keep the schedule; staying honest under that pressure is the core quality of the trade, because one wrong signature can lead to failure and loss of life."},
   ],
   foot:{vi:"Tóm lại: thanh tra tạo giá trị bằng tính ĐỘC LẬP và hiểu hệ thống — không phải bằng việc tự tay sửa hay nới tiêu chuẩn.",en:"In short: the inspector creates value through INDEPENDENCE and system understanding — not by repairing or relaxing the standard."}},
 ],
 quiz:[
 ...
 deep:[
  {h_vi:"Vật lý hồ quang quyết định cách chọn quá trình",h_en:"Arc physics drives the process choice",
   body:[
    ...
    {vi:"Đặc tính nguồn hàn là lý do thợ tay và máy tự động cần thiết bị khác nhau. Nguồn CC (dòng không đổi, đặc tính dốc) giữ dòng gần như cố định dù chiều dài hồ quang dao động — thiết yếu cho MMA/TIG vì tay người luôn rung, dòng ổn định giữ nhiệt ổn định. Nguồn CV (áp không đổi, đặc tính phẳng) cho phép 'hồ quang tự điều chỉnh': khi tầm với dây ngắn lại, dòng vọt lên đốt dây nhanh hơn, tự kéo chiều dài hồ quang về cũ — nhờ vậy MIG/MAG/SAW chạy dây liên tục mà không cần thợ canh chiều dài hồ quang. Chọn sai đặc tính nguồn thì quá trình không thể vận hành ổn định.",en:"The power-source characteristic is why a hand welder and an automatic machine need different equipment. A CC source (constant current, drooping) holds current almost fixed even as arc length varies — essential for MMA/TIG because the human hand always wavers, and steady current keeps heat steady. A CV source (constant voltage, flat) enables the 'self-adjusting arc': when stick-out shortens, current surges and burns the wire faster, pulling arc length back to its setting — which lets MIG/MAG/SAW run continuous wire without the operator nursing arc length. Pick the wrong characteristic and the process cannot run stably."},
    {vi:"Nhiệt đầu vào là cây cầu nối lựa chọn quá trình với KẾT QUẢ LUYỆN KIM, không chỉ năng suất. Nhiệt đầu vào cao (SAW, dây to) làm nguội chậm → HAZ hạt thô, mềm hơn, ít nứt hydro nhưng độ dai có thể giảm và biến dạng nhiều hơn; nhiệt đầu vào thấp (dip, tấm mỏng) nguội nhanh → HAZ cứng hơn, rủi ro nứt hydro cao hơn nếu thép nhạy. Vì thế chọn quá trình và thông số không chỉ là 'hàn nhanh hay chậm' mà là quyết định tổ chức tế vi, độ cứng, biến dạng và rủi ro nứt của mối hàn — đúng phần mà kỹ sư hàn phân tích khi lập WPS.",en:"Heat input is the bridge linking the process choice to the METALLURGICAL outcome, not just productivity. High heat input (SAW, large wire) cools slowly → a coarse-grained, softer HAZ, less hydrogen cracking but possibly lower toughness and more distortion; low heat input (dip, thin sheet) cools fast → a harder HAZ, higher hydrogen-cracking risk on sensitive steel. So choosing the process and parameters is not just 'fast or slow welding' but a decision about the weld's microstructure, hardness, distortion and cracking risk — exactly what a welding engineer analyses when writing the WPS."},
   ],
   foot:{vi:"Vật lý gốc: dòng–áp → kiểu chuyển dịch → ngấu & vị trí; đặc tính nguồn → ổn định hồ quang; nhiệt đầu vào → luyện kim. Nắm ba trục này là chọn quá trình có cơ sở.",en:"Root physics: current–voltage → transfer mode → penetration & position; source characteristic → arc stability; heat input → metallurgy. Master these three axes and the process choice is well-founded."}},
  {h_vi:"Chọn quá trình hàn theo việc",h_en:"Choosing the process for the job",
   rows:[
    {vi:"Theo CHIỀU DÀY & VỊ TRÍ: tấm mỏng / hàn mọi vị trí → TIG hoặc MIG dip/pulsed. Tấm dày → SAW hoặc FCAW để có năng suất.",en:"By THICKNESS & POSITION: thin sheet / all-position → TIG or dip/pulsed MIG. Thick → SAW or FCAW for output."},
    {vi:"Theo VẬT LIỆU: inox/nhôm/titan, lớp lót ống → TIG (sạch, chất lượng). Thép kết cấu cần năng suất → MAG/FCAW. Mối dài thẳng trong xưởng → SAW.",en:"By MATERIAL: stainless/aluminium/titanium, pipe roots → TIG (clean, high quality). Structural steel for output → MAG/FCAW. Long straight shop seams → SAW."},
    {vi:"Theo MÔI TRƯỜNG: ngoài trời/có gió → MMA hoặc FCAW tự bảo vệ. ĐỪNG dùng MIG/MAG ngoài gió — khí bảo vệ bị thổi bay → rỗ khí.",en:"By ENVIRONMENT: outdoors/windy → MMA or self-shielded FCAW. Do NOT use MIG/MAG in wind — shielding blows away → porosity."},
    {vi:"Cân bằng 4 yếu tố: NĂNG SUẤT ↔ CHẤT LƯỢNG ↔ TAY NGHỀ THỢ ↔ CHI PHÍ. Năng suất tăng dần: TIG < MMA < MAG < FCAW < SAW. Độ sạch/chất lượng: TIG dẫn đầu.",en:"Balance 4 factors: OUTPUT ↔ QUALITY ↔ WELDER SKILL ↔ COST. Output rises: TIG < MMA < MAG < FCAW < SAW. Cleanliness/quality: TIG leads."},
   ]},
  {h_vi:"GMAW dạng sóng — công nghệ thay TIG cho lớp lót",h_en:"Waveform GMAW — modern tech replacing TIG roots",
   rows:[
    {vi:"Pulsed MIG (xung): dòng nền thấp + xung cao → được dạng spray ở dòng trung bình thấp → hàn MỌI VỊ TRÍ, ít bắn tóe, kiểm soát nhiệt tốt.",en:"Pulsed MIG: low background + high pulse → spray transfer at low average current → ALL-POSITION, low spatter, good heat control."},
    {vi:"STT (Surface Tension Transfer) & RMD (Regulated Metal Deposition): điều khiển chính xác giọt ngay lúc ngắn mạch → lớp lót (root) ống ĐẸP, ngấu ổn định, ít lỗi, hydro thấp. RMD hàn được root P91/inox mà không cần đập chặn khí lưng (purge dam).",en:"STT (Surface Tension Transfer) & RMD (Regulated Metal Deposition): precisely control the droplet at short-circuit → clean pipe ROOTS, stable penetration, fewer defects, low hydrogen. RMD can run P91/stainless roots without an internal purge dam."},
    {vi:"CMT (Cold Metal Transfer): rút dây cơ học mỗi lần ngắn mạch → nhiệt RẤT thấp, gần như không bắn tóe → tấm mỏng, nhôm, hàn dị chất thép–nhôm, đắp, root SCR ngoài khơi.",en:"CMT (Cold Metal Transfer): mechanically retracts the wire each short-circuit → VERY low heat, almost no spatter → thin sheet, aluminium, steel–aluminium dissimilar, overlay, offshore SCR roots."},
    {vi:"Ý nghĩa với thanh tra: các chế độ này thay TIG root → nhanh hơn nhiều, ít lỗi; NHƯNG WPS & thợ phải được phê duyệt cho đúng chế độ; máy synergic lưu thông số → kiểm tra đang chạy đúng chương trình/đường cong.",en:"Inspector takeaway: these modes replace TIG roots → much faster, fewer defects; BUT the WPS & welder must be qualified for that mode; synergic machines store parameters → verify the correct program/curve is loaded."},
   ]},
  {h_vi:"TIG nâng cao (năng suất & tự động)",h_en:"Advanced TIG (productivity & automation)",
   rows:[
    {vi:"A-TIG (TIG có flux kích hoạt): phủ một lớp flux mỏng lên mối nối → tăng CHIỀU SÂU NGẤU 2–3 lần trong một lớp, hàn dày hơn mà không cần vát mép; hay dùng cho inox.",en:"A-TIG (activated-flux TIG): a thin flux layer on the joint → 2–3× deeper PENETRATION in one pass, welds thicker without a bevel; common on stainless."},
    {vi:"Hot-wire TIG: nung dây đắp trước bằng dòng phụ → tăng mạnh năng suất đắp (cladding/overlay) mà vẫn giữ chất lượng TIG.",en:"Hot-wire TIG: a secondary current pre-heats the filler → big jump in deposition for cladding/overlay while keeping TIG quality."},
    {vi:"Orbital TIG: đầu hàn tự động quay quanh ống → mối đồng đều, lặp lại, ít phụ thuộc tay nghề; dùng cho ống dược/thực phẩm/bán dẫn (yêu cầu sạch).",en:"Orbital TIG: the head rotates automatically around the pipe → uniform, repeatable welds, less skill-dependent; used for pharma/food/semiconductor tube (high cleanliness)."},
   ]},
  {h_vi:"Năng suất cao, laser & cơ giới hóa",h_en:"High-deposition, laser & mechanization",
   rows:[
    {vi:"Tandem/twin & multi-wire SAW: nhiều dây cùng lúc → tốc độ rất cao cho mối dài (bồn, ống lớn, kết cấu nặng).",en:"Tandem/twin & multi-wire SAW: several wires at once → very high speed on long seams (vessels, large pipe, heavy structures)."},
    {vi:"FCAW (dây lõi thuốc): năng suất cao hơn dây đặc, hàn vị trí tốt. Loại tự bảo vệ (114) chịu gió → công trường; loại có khí (136) cho mối đẹp.",en:"FCAW (flux-cored wire): higher output than solid wire, good positional. Self-shielded (114) tolerates wind → site work; gas-shielded (136) gives a cleaner bead."},
    {vi:"Laser & laser-hybrid (laser + MAG): ngấu RẤT sâu, biến dạng thấp, tốc độ cao — nhưng đòi hỏi lắp ghép (fit-up) khít, dung sai nhỏ.",en:"Laser & laser-hybrid (laser + MAG): VERY deep penetration, low distortion, high speed — but demands tight fit-up and small tolerances."},
    {vi:"Laser cầm tay (handheld) & robot/cobot hàn: đang phổ biến nhanh (2025–2026) — lặp lại ổn định, giảm phụ thuộc thợ. Thanh tra chuyển trọng tâm sang kiểm soát thông số, lập trình & hiệu chuẩn cảm biến/seam-tracking.",en:"Handheld laser & welding robots/cobots: spreading fast (2025–2026) — stable repeatability, less skill-dependent. The inspector's focus shifts to parameter control, programming & sensor/seam-tracking calibration."},
   ]},
  {h_vi:"Bồi đắp & hàn trạng thái rắn",h_en:"Additive & solid-state welding",
   rows:[
    {vi:"WAAM (Wire Arc Additive Manufacturing): dùng hồ quang (MIG/CMT/plasma) đắp lớp tạo chi tiết LỚN gần hình dạng cuối → chế tạo & sửa chữa chi tiết lớn, tiết kiệm vật liệu; phải kiểm soát nhiệt giữa lớp & ứng suất dư.",en:"WAAM (Wire Arc Additive Manufacturing): an arc (MIG/CMT/plasma) deposits layers to build LARGE near-net-shape parts → fabrication & repair of big components, less material waste; must control interpass heat & residual stress."},
    {vi:"Hàn phủ (cladding/overlay) chống ăn mòn/mài mòn: phủ inox/Inconel/hardfacing lên thép nền; kiểm soát ĐỘ PHA LOÃNG (dilution) và chiều dày lớp phủ để giữ thành phần bề mặt.",en:"Cladding/overlay for corrosion/wear: deposit stainless/Inconel/hardfacing on a steel base; control DILUTION and layer thickness to keep the surface composition."},
    {vi:"FSW (Friction Stir Welding) — trạng thái RẮN, không nóng chảy: cho nhôm/hợp kim nhẹ → không rỗ khí, không nứt nóng, biến dạng thấp; dùng hàng không, ô tô, bồn nhôm.",en:"FSW (Friction Stir Welding) — SOLID-state, no melting: for aluminium/light alloys → no gas porosity, no hot cracking, low distortion; used in aerospace, automotive, aluminium tanks."},
   ],
   table:{
    cols:[{vi:"Quá trình",en:"Process"},{vi:"Năng suất",en:"Output"},{vi:"Vị trí",en:"Position"},{vi:"Điển hình dùng",en:"Typical use"}],
    data:[
     [{vi:"TIG (141)",en:"TIG (141)"},{vi:"Thấp",en:"Low"},{vi:"Mọi vị trí",en:"All"},{vi:"Root ống, inox/nhôm/titan, chất lượng cao",en:"Pipe roots, stainless/Al/Ti, high quality"}],
     [{vi:"Pulsed / STT / RMD",en:"Pulsed / STT / RMD"},{vi:"TB–cao",en:"Med–high"},{vi:"Mọi vị trí",en:"All"},{vi:"Root & điền ống — thay TIG root, nhanh hơn",en:"Pipe root & fill — replaces TIG root, faster"}],
     [{vi:"CMT",en:"CMT"},{vi:"Trung bình",en:"Medium"},{vi:"Mọi vị trí",en:"All"},{vi:"Tấm mỏng, nhôm, dị chất, đắp",en:"Thin sheet, aluminium, dissimilar, overlay"}],
     [{vi:"MAG (135)",en:"MAG (135)"},{vi:"Cao",en:"High"},{vi:"Mọi vị trí (dip/pulsed)",en:"All (dip/pulsed)"},{vi:"Thép kết cấu cần năng suất",en:"Structural steel for output"}],
     [{vi:"FCAW (136/114)",en:"FCAW (136/114)"},{vi:"Cao",en:"High"},{vi:"Tốt",en:"Good"},{vi:"Tấm dày, công trường, chịu gió (tự bảo vệ)",en:"Thick, site, wind-tolerant (self-shielded)"}],
     [{vi:"SAW (121)",en:"SAW (121)"},{vi:"Rất cao",en:"Very high"},{vi:"Bằng/ngang",en:"Flat/horizontal"},{vi:"Mối dài thẳng trong xưởng",en:"Long straight shop seams"}],
     [{vi:"Laser-hybrid",en:"Laser-hybrid"},{vi:"Rất cao",en:"Very high"},{vi:"Cơ giới",en:"Mechanized"},{vi:"Dày, biến dạng thấp, cần fit-up khít",en:"Thick, low distortion, tight fit-up"}],
    ]},
   foot:{vi:"Quy tắc: chọn quá trình theo VIỆC (vật liệu, chiều dày, vị trí, môi trường, sản lượng) — không theo thói quen hay thiết bị sẵn có.",en:"Rule: pick the process by the JOB (material, thickness, position, environment, volume) — not by habit or whatever machine is on hand."}},
 ],
 quiz:[
  ...
  {vi:"Chế độ GMAW nào điều khiển giọt ngay lúc ngắn mạch, hay dùng thay TIG cho lớp lót ống?",en:"Which GMAW mode controls the droplet at short-circuit and is used to replace TIG for pipe roots?",
   opts:[{vi:"Spray",en:"Spray"},{vi:"STT / RMD (ngắn mạch điều khiển)",en:"STT / RMD (controlled short-circuit)"},{vi:"Globular",en:"Globular"},{vi:"SAW",en:"SAW"}],ans:1,
   exp:{vi:"STT/RMD điều khiển chính xác giọt lúc ngắn mạch → root ống đẹp, ít lỗi, hydro thấp — nhanh hơn TIG root.",en:"STT/RMD precisely control the droplet at short-circuit → clean pipe roots, fewer defects, low hydrogen — faster than a TIG root."}},
  {vi:"A-TIG (TIG có flux kích hoạt) mang lại lợi ích chính gì?",en:"What is the main benefit of A-TIG (activated-flux TIG)?",
   opts:[{vi:"Hàn nhanh gấp 10 lần",en:"10× faster welding"},{vi:"Tăng ngấu sâu 2–3 lần, hàn dày hơn không cần vát",en:"2–3× deeper penetration, welds thicker without a bevel"},{vi:"Không cần khí bảo vệ",en:"No shielding gas needed"},{vi:"Chỉ dùng cho nhôm",en:"Aluminium only"}],ans:1,
   exp:{vi:"Lớp flux mỏng làm hẹp hồ quang → ngấu sâu hơn 2–3 lần trong một lớp, giảm số lớp/không cần vát.",en:"The thin flux constricts the arc → 2–3× deeper penetration in one pass, fewer passes / no bevel."}},
  {vi:"FSW (friction stir) khác các quá trình hồ quang ở điểm cốt lõi nào?",en:"How does FSW (friction stir) fundamentally differ from arc processes?",
   opts:[{vi:"Dùng tia laser",en:"It uses a laser beam"},{vi:"Hàn ở trạng thái RẮN, không nóng chảy (cho nhôm)",en:"It welds in the SOLID state, no melting (for aluminium)"},{vi:"Cần que bọc thuốc",en:"It needs a covered electrode"},{vi:"Chỉ hàn thép dày",en:"Thick steel only"}],ans:1,
   exp:{vi:"FSW dùng ma sát-khuấy ở trạng thái rắn (không nóng chảy) → không rỗ khí, không nứt nóng, biến dạng thấp; lý tưởng cho nhôm.",en:"FSW uses solid-state friction stirring (no melting) → no gas porosity, no hot cracking, low distortion; ideal for aluminium."}},
 ]},
...
{vi:"Vật liệu hàn (Consumables)", en:"Welding Consumables",
 ...
 deep:[
  {h_vi:"Luyện kim của vật liệu hàn — vì sao thiết kế như vậy",h_en:"The metallurgy of consumables — why they are designed this way",
   body:[
    {vi:"Lớp thuốc bọc không chỉ 'bảo vệ' mà định hình cơ tính mối hàn qua ĐỘ BAZƠ (basicity). Thuốc bazơ cao (basic) chứa nhiều CaCO3/CaF2 → khử tạp chất (S, P, oxy), cho kim loại đắp sạch, DAI và ÍT HYDRO — nên dùng cho thép dày, chịu lực, làm việc nhiệt độ thấp; đổi lại hồ quang khó hơn, ngoại quan kém. Thuốc rutile (nhiều TiO2) dễ hàn, hồ quang êm, đẹp, nhưng độ dai và khả năng chống nứt kém hơn. Cellulosic cháy sinh nhiều khí H2/CO → hồ quang mạnh, ngấu sâu (lý tưởng cho lớp lót ống hàn tụt) nhưng hydro RẤT cao. Vậy 'chọn que' thực chất là chọn đánh đổi giữa độ dai/chống nứt và tính dễ hàn/ngoại quan.",en:"The flux coating does not merely 'protect' — it shapes the weld's mechanical properties through BASICITY. A highly basic coating (CaCO3/CaF2-rich) refines impurities (S, P, oxygen), giving a clean, TOUGH, LOW-HYDROGEN deposit — for thick, load-bearing, low-temperature steel; the trade-off is a harsher arc and poorer appearance. Rutile coatings (TiO2-rich) run easily with a smooth arc and good looks, but with lower toughness and crack resistance. Cellulosic coatings burn to release H2/CO gas → a fierce, deep-penetrating arc (ideal for vertical-down pipe roots) but VERY high hydrogen. So 'choosing a rod' is really choosing a trade-off between toughness/crack-resistance and operability/appearance."},
    {vi:"Kiểm soát hydro là bài toán định lượng chứ không phải khẩu hiệu. Nguồn hydro chính là HƠI ẨM trong lớp thuốc; thuốc bazơ hút ẩm nên được phân loại theo thang hydro khuếch tán H5/H10/H15 (≤5, ≤10, ≤15 ml H2/100g kim loại đắp). Sấy 300–350°C tách ẩm liên kết, tủ giữ 120–150°C và ống đựng ~70°C ngăn hút ẩm lại; phơi ngoài không khí quá ~4 giờ là phải sấy lại. Que đóng gói chân không dùng được ngay nếu bao còn nguyên. Hiểu cơ chế này giải thích vì sao một quy trình sấy sai có thể TRỰC TIẾP gây nứt nguội dù đã chọn đúng mác que.",en:"Hydrogen control is a quantitative problem, not a slogan. The main hydrogen source is MOISTURE in the coating; basic coatings absorb moisture, so they are graded by diffusible-hydrogen scales H5/H10/H15 (≤5, ≤10, ≤15 ml H2/100 g deposited metal). Baking at 300–350°C drives off bound moisture; a holding oven at 120–150°C and a quiver at ~70°C stop re-absorption; more than ~4 h of atmospheric exposure means re-baking. Vacuum-packed rods can be used straight away if the pack is intact. Understanding this is why a wrong baking routine can DIRECTLY cause hydrogen cracking even with the correct rod grade chosen."},
    {vi:"Thuốc và dây còn làm nhiệm vụ KHỬ OXY và CHUYỂN HỢP KIM, ảnh hưởng trực tiếp cơ tính. Mn và Si trong dây/thuốc khử oxy trong vũng hàn (giảm rỗ, giảm FeO) và một phần đi vào kim loại đắp làm tăng bền. Với SAW, thuốc thiêu kết (agglomerated) có thể THÊM hợp kim và khử oxy cho mối dai hơn, nhưng hút ẩm nên phải bảo quản như que basic; thuốc nung chảy (fused) bền và không hút ẩm nhưng không thêm được hợp kim. Đó là lý do cùng một dây nhưng đổi loại thuốc SAW có thể làm đổi hẳn cơ tính mối hàn.",en:"Fluxes and wires also DEOXIDISE and TRANSFER ALLOY, directly affecting properties. Mn and Si in the wire/flux deoxidise the pool (less porosity, less FeO) and partly enter the deposit to raise strength. In SAW, an agglomerated flux can ADD alloy and deoxidise for a tougher weld but is hygroscopic and must be stored like basic rods; a fused flux is robust and non-hygroscopic but cannot add alloy. That is why the same wire with a different SAW flux can completely change the weld's mechanical properties."},
    {vi:"Khí bảo vệ là một 'thành phần luyện kim' chứ không hoàn toàn trơ. CO2 trong hồ quang phân ly thành CO và O → oxy hóa nhẹ vũng hàn (cần Mn/Si bù lại), cho ngấu sâu và rẻ nhưng nhiều bắn tóe và chỉ dip/globular. Thêm Ar (Ar+5–20% CO2 hoặc Ar+O2) ổn định hồ quang, cho phép spray, mối mượt và ít bắn tóe. Độ tinh khiết và điểm sương của khí rất quan trọng: hơi ẩm trong khí cũng là nguồn hydro và rỗ khí. Vì vậy chọn khí là cân bằng giữa ngấu, độ sạch, bắn tóe và chi phí — một quyết định kỹ thuật, không phải mặc định.",en:"Shielding gas is a 'metallurgical ingredient', not fully inert. CO2 in the arc dissociates into CO and O → it mildly oxidises the pool (needing Mn/Si to compensate), giving deep penetration cheaply but heavy spatter and dip/globular only. Adding Ar (Ar+5–20% CO2, or Ar+O2) stabilises the arc, allows spray, and gives a smooth, low-spatter bead. Gas purity and dew point matter: moisture in the gas is also a hydrogen and porosity source. So gas selection balances penetration, cleanliness, spatter and cost — an engineering decision, not a default."},
   ],
   foot:{vi:"Lõi vấn đề: hóa học thuốc/khí + kiểm soát hydro + khử oxy/chuyển hợp kim quyết định cơ tính. Chọn vật liệu hàn là chọn luyện kim của mối hàn.",en:"The crux: flux/gas chemistry + hydrogen control + deoxidation/alloy transfer determine the properties. Choosing a consumable is choosing the weld's metallurgy."}},
  {h_vi:"Nguyên tắc chọn vật liệu hàn — 4 câu hỏi",h_en:"How to choose a consumable — 4 questions",
   rows:[
    {vi:"1) CƠ TÍNH: kim loại đắp phải có độ bền kéo ≥ kim loại cơ bản với cấu kiện chịu lực ('matching'). Thép cường độ rất cao đôi khi chọn 'undermatching' để giảm ứng suất & nứt hydro.",en:"1) MECHANICAL: deposit tensile must be ≥ base metal for load-bearing joints ('matching'). Very high-strength steels are sometimes 'undermatched' to cut stress and hydrogen cracking."},
    {vi:"2) THÀNH PHẦN & CHỐNG ĂN MÒN: với thép hợp kim/inox, kim loại đắp phải khớp thành phần để giữ tính chống ăn mòn (vd hàn 316L bằng 316L).",en:"2) COMPOSITION & CORROSION: for alloy/stainless steels the deposit must match composition to keep corrosion resistance (e.g. weld 316L with 316L)."},
    {vi:"3) ĐIỀU KIỆN CHẾ TẠO: quá trình hàn (SMAW/TIG/MIG/SAW), vị trí hàn, có thổi khí lưng hay không → quyết định dạng vật liệu (que bọc / dây / hậu tố).",en:"3) FABRICATION: process (SMAW/TIG/MIG/SAW), position, back-purge or not → drives the product form (covered rod / wire / suffix)."},
    {vi:"4) ĐIỀU KIỆN LÀM VIỆC: nhiệt độ, môi trường, có xử lý nhiệt sau hàn (PWHT) hay không → quyết định hậu tố L/H, có Mo, v.v.",en:"4) SERVICE: temperature, environment, PWHT or as-welded → drives the suffix (L/H, Mo, etc.)."},
    {vi:"Luôn theo WPS đã phê duyệt — thanh tra KHÔNG cho phép đổi mác/đường kính vật liệu hàn ngoài WPS.",en:"Always follow the approved WPS — the inspector does NOT allow off-WPS changes of consumable class or size."},
   ]},
  {h_vi:"Giải mã ký hiệu vật liệu hàn INOX",h_en:"Decoding stainless consumable designations",
   rows:[
    {vi:"ER… (AWS A5.9) = dây/que đắp TRẦN cho TIG, MIG/MAG, SAW. E… (AWS A5.4) = que BỌC THUỐC cho hàn tay (SMAW). Vd: ER316L để TIG/MIG, E316L-16 để hàn que.",en:"ER… (AWS A5.9) = BARE rod/wire for TIG, MIG/MAG, SAW. E… (AWS A5.4) = COVERED electrode for stick (SMAW). E.g. ER316L for TIG/MIG, E316L-16 for stick."},
    {vi:"Hậu tố L (low carbon, C ≤ 0,03%): chống tiết carbide (sensitization) ở 450–850°C → chống ăn mòn liên tinh. Chọn khi hàn xong KHÔNG xử lý nhiệt & môi trường ăn mòn.",en:"Suffix L (low carbon, C ≤ 0.03%): resists carbide precipitation (sensitization) at 450–850°C → avoids intergranular corrosion. Pick it for as-welded, corrosive service."},
    {vi:"Hậu tố H (carbon cao 0,04–0,10%): tăng độ bền & chống dão (creep) ở nhiệt độ cao. Chọn cho dịch vụ nhiệt độ cao (vd 316H).",en:"Suffix H (higher carbon 0.04–0.10%): more creep/high-temperature strength. Pick it for elevated-temperature service (e.g. 316H)."},
    {vi:"Hậu tố Si (vd ER316LSi, Si ~0,65–1,0%): tăng độ ướt/loang, bead mịn, hồ quang ổn định, ít bắn tóe & rỗ → lý tưởng cho MIG/MAG. Đánh đổi: hơi tăng nhạy nứt nóng nếu ferrite thấp.",en:"Suffix Si (e.g. ER316LSi, Si ~0.65–1.0%): better wetting/wash, smoother bead, stable arc, less spatter & porosity → ideal for MIG/MAG. Trade-off: a little more hot-crack sensitive if ferrite is low."},
    {vi:"Mo trong 316/316L (~2–3% Mo): chống ăn mòn rỗ (pitting) trong môi trường clorua tốt hơn hẳn 304/308.",en:"Mo in 316/316L (~2–3% Mo): much better pitting resistance in chloride environments than 304/308."},
   ],
   table:{
    cols:[{vi:"Hậu tố",en:"Suffix"},{vi:"Vỏ bọc",en:"Coating"},{vi:"Dòng điện",en:"Current"},{vi:"Đặc tính & khi nào chọn",en:"Traits & when to pick"}],
    data:[
     [{vi:"-15",en:"-15"},{vi:"Basic (vôi–fluorit)",en:"Basic (lime-fluoride)"},{vi:"Chỉ DC+ (DCEP)",en:"DC+ (DCEP) only"},{vi:"Độ dai/va đập cao nhất, chống nứt — chọn khi ràng buộc lớn, dày, cần impact",en:"Highest toughness/impact, crack-resistant — pick for high restraint, thick, impact-rated work"}],
     [{vi:"-16",en:"-16"},{vi:"Rutile (titania–vôi)",en:"Rutile (titania-lime)"},{vi:"AC & DC+",en:"AC & DC+"},{vi:"Dễ hàn, hồ quang êm, ngoại quan đẹp — đa dụng, mọi vị trí",en:"Easy to run, smooth arc, good appearance — general purpose, all-position"}],
     [{vi:"-17",en:"-17"},{vi:"Acid–silica (nhiều silica)",en:"Acid-silica (high silica)"},{vi:"AC & DC+",en:"AC & DC+"},{vi:"Bead phẳng–mịn nhất, xỉ dễ tách — tấm mỏng, ưu tiên ngoại quan",en:"Flattest/smoothest bead, easy slag release — thin sheet, appearance-critical"}],
    ]},
   foot:{vi:"Số hậu tố -15/-16/-17 KHÔNG đổi cơ/hóa tính mối hàn — chỉ đổi đặc tính vận hành, loại dòng điện & vị trí hàn.",en:"The -15/-16/-17 number does NOT change weld mechanical/chemical properties — only operability, current type and position."}},
  {h_vi:"Ví dụ thực chiến: hàn 316L thì chọn gì?",h_en:"Worked example: welding 316L — what to pick",
   rows:[
    {vi:"Lớp lót (root) TIG: ER316L (hoặc ER316LSi). BẮT BUỘC thổi khí lưng (Ar) để chống oxy hóa mặt sau (hiện tượng 'sugaring').",en:"TIG root: ER316L (or ER316LSi). Mandatory Ar back-purge to prevent root-side oxidation ('sugaring')."},
    {vi:"Hàn que (SMAW): E316L-16 cho đa số việc; E316L-15 khi ràng buộc lớn / cần độ dai cao. Vẫn sấy & giữ que như loại basic.",en:"Stick (SMAW): E316L-16 for most work; E316L-15 for high restraint / impact needs. Still bake & hold like basic rods."},
    {vi:"MIG/MAG: ER316LSi cho bead đẹp, ướt tốt. Khí: Ar + 1–2% O2 hoặc Ar + ~2–3% CO2 (giữ CO2 thấp để không nạp carbon làm mất tính 'L').",en:"MIG/MAG: ER316LSi for a clean, well-wetted bead. Gas: Ar + 1–2% O2 or Ar + ~2–3% CO2 (keep CO2 low so it does not carburise and spoil the 'L')."},
    {vi:"Vì sao LUÔN là 'L': 316L sau hàn thường KHÔNG xử lý nhiệt → kim loại đắp phải C thấp để tránh sensitization. Dùng que 316 (không L) cho base 316L trong dịch vụ ăn mòn = vứt bỏ lợi thế chống ăn mòn.",en:"Why ALWAYS 'L': 316L is usually left as-welded → the deposit must be low-carbon to avoid sensitization. Using non-L 316 filler on 316L base in corrosive service throws away the corrosion advantage."},
   ]},
  {h_vi:"Mối hàn khác vật liệu (inox ↔ thép carbon)",h_en:"Dissimilar joints (stainless ↔ carbon steel)",
   rows:[
    {vi:"KHÔNG dùng 316L để hàn inox với thép carbon: bị thép carbon pha loãng (dilution) → mối hàn hóa martensite giòn, dễ nứt.",en:"Do NOT use 316L to join stainless to carbon steel: dilution from the carbon steel makes the weld martensitic and crack-prone."},
    {vi:"Dùng 309L (23Cr–13Ni) hoặc 309LMo (giữ Mo nếu một bên là 316): quá hợp kim nên 'chịu' được pha loãng, vẫn cho tổ chức austenit + ferrite chống nứt.",en:"Use 309L (23Cr–13Ni) or 309LMo (keeps Mo if one side is 316): over-alloyed to tolerate dilution and still give a crack-resistant austenite + ferrite structure."},
    {vi:"309L cũng dùng làm lớp 'đệm' (buttering) trước khi phủ 316L. 312 (29Cr–9Ni) ferrite rất cao — dùng cho thép khó hàn/không rõ mác.",en:"309L is also used as a buttering layer before a 316L overlay. 312 (29Cr–9Ni) is very high-ferrite — for hard-to-weld/unknown steels."},
   ]},
  {h_vi:"Kiểm soát Ferrite (FN) chống nứt nóng",h_en:"Ferrite control against hot cracking",
   rows:[
    {vi:"Mối hàn austenit HOÀN TOÀN (0 ferrite) dễ nứt nóng (solidification cracking) do S, P thiên tích ở biên hạt khi đông đặc.",en:"A fully austenitic weld (zero ferrite) is prone to hot (solidification) cracking because S and P segregate to grain boundaries on freezing."},
    {vi:"Giữ một ít delta-ferrite — thường FN 3–10 (điển hình 4–10) — trong kim loại đắp để chặn nứt nóng.",en:"Keep a little delta-ferrite — typically FN 3–10 (often 4–10) — in the deposit to stop hot cracking."},
    {vi:"Dự đoán ferrite bằng giản đồ Schaeffler / DeLong / WRC-1992 từ Creq (Cr+Mo+Si+Nb) và Nieq (Ni+C+Mn+N); đo thực tế bằng ferritescope.",en:"Predict ferrite from Schaeffler / DeLong / WRC-1992 diagrams using Creq (Cr+Mo+Si+Nb) and Nieq (Ni+C+Mn+N); measure it with a ferritescope."},
    {vi:"Lưu ý ngược lại: dịch vụ nhiệt độ rất cao, môi trường acid đặc hoặc yêu cầu phi-từ tính có thể GIỚI HẠN ferrite trên — cân bằng theo spec.",en:"Caveat: very high-temp service, strong-acid media or non-magnetic requirements may CAP the upper ferrite — balance per the spec."},
   ]},
 ],
 quiz:[
  ...
  {vi:"Vì sao chọn 316L thay vì 316 cho mối hàn để nguyên (as-welded) trong môi trường ăn mòn?",en:"Why pick 316L over 316 for an as-welded joint in a corrosive environment?",
   opts:[{vi:"Để mối hàn cứng hơn",en:"To make the weld harder"},{vi:"C thấp (≤0,03%) tránh tiết carbide → chống ăn mòn liên tinh",en:"Low C (≤0.03%) avoids carbide precipitation → resists intergranular corrosion"},{vi:"Để bền hơn ở nhiệt độ cao",en:"For more high-temperature strength"},{vi:"Vì rẻ hơn",en:"Because it is cheaper"}],ans:1,
   exp:{vi:"L = C ≤0,03% → không tiết carbide (sensitization) ở 450–850°C khi không PWHT → giữ chống ăn mòn liên tinh.",en:"L = C ≤0.03% → no carbide precipitation (sensitization) at 450–850°C when left as-welded → keeps intergranular-corrosion resistance."}},
  {vi:"Hàn inox 316L với thép carbon nên dùng vật liệu hàn nào?",en:"Which consumable to join 316L stainless to carbon steel?",
   opts:[{vi:"316L",en:"316L"},{vi:"309L / 309LMo",en:"309L / 309LMo"},{vi:"308L",en:"308L"},{vi:"Que thép carbon thường",en:"Plain carbon-steel rod"}],ans:1,
   exp:{vi:"309L/309LMo quá hợp kim nên chịu được pha loãng từ thép carbon, tránh mối hàn martensite giòn; 316L sẽ bị pha loãng gây nứt.",en:"309L/309LMo is over-alloyed to tolerate dilution from the carbon steel and avoid a brittle martensitic weld; 316L would be diluted and crack."}},
  {vi:"ER316LSi khác ER316L ở điểm nào và dùng tốt nhất cho quá trình nào?",en:"How does ER316LSi differ from ER316L, and which process suits it best?",
   opts:[{vi:"Carbon cao hơn — cho hàn tay",en:"Higher carbon — for stick"},{vi:"Silicon cao hơn → ướt tốt, bead mịn — cho MIG/MAG",en:"Higher silicon → better wetting, smoother bead — for MIG/MAG"},{vi:"Không có Mo — cho 304",en:"No molybdenum — for 304"},{vi:"Bền kéo cao hơn — cho SAW",en:"Higher tensile — for SAW"}],ans:1,
   exp:{vi:"Si ~0,65–1,0% tăng độ ướt/loang, hồ quang ổn định, ít bắn tóe — lý tưởng cho MIG/MAG; cùng C thấp như 316L.",en:"Si ~0.65–1.0% improves wetting/wash, stabilises the arc, cuts spatter — ideal for MIG/MAG; same low carbon as 316L."}},
 ]},
...
{vi:"Ký hiệu mối hàn & bản vẽ", en:"Welding Symbols & Drawings",
 ...
 deep:[
  {h_vi:"Đọc ký hiệu mối hàn — phương pháp và bẫy ISO/AWS",h_en:"Reading weld symbols — method and the ISO/AWS trap",
   body:[
    {vi:"Một ký hiệu mối hàn được đọc theo cấu trúc cố định: ĐƯỜNG THAM CHIẾU (reference line) nằm ngang mang mọi thông tin; MŨI TÊN (arrow) chỉ tới mối nối; ĐUÔI (tail) ghi quá trình/WPS/tiêu chuẩn khi cần. Điều quyết định là VỊ TRÍ ký hiệu so với đường tham chiếu: nó cho biết mối hàn nằm ở 'mặt mũi tên' (arrow side) hay 'mặt kia' (other side). Đọc sai vị trí này nghĩa là hàn nhầm phía tấm — một lỗi tốn kém mà thanh tra phải chặn ngay từ khâu đọc bản vẽ.",en:"A weld symbol is read in a fixed structure: the horizontal REFERENCE LINE carries all the information; the ARROW points to the joint; the TAIL records the process/WPS/standard when needed. The decisive thing is the POSITION of the symbol relative to the reference line: it tells you whether the weld is on the 'arrow side' or the 'other side'. Misreading that position means welding the wrong face of the plate — a costly error the inspector must stop at the drawing-reading stage."},
    {vi:"Cạm bẫy lớn nhất là ISO 2553 và AWS A2.4 quy ước NGƯỢC nhau (xem bảng). ISO dùng hai đường — liền (reference) và đứt nét (identification): ký hiệu trên đường LIỀN là mặt mũi tên, trên đường ĐỨT là mặt kia. AWS dùng một đường: ký hiệu DƯỚI đường là mặt mũi tên, TRÊN đường là mặt kia. Vì thế cùng một hình vẽ có thể mang ý nghĩa trái ngược tùy hệ; việc đầu tiên khi cầm bản vẽ là xác định nó theo ISO hay AWS, nếu không mọi diễn giải sau đều rủi ro.",en:"The biggest trap is that ISO 2553 and AWS A2.4 use OPPOSITE conventions (see table). ISO uses two lines — a solid (reference) and a dashed (identification): a symbol on the SOLID line is arrow side, on the DASHED line is other side. AWS uses one line: a symbol BELOW the line is arrow side, ABOVE is other side. So the same drawing can mean opposite things depending on the system; the first thing to do with any drawing is establish whether it is ISO or AWS, otherwise every later interpretation is at risk."},
    {vi:"Các con số quanh ký hiệu là yêu cầu BẮT BUỘC, không phải gợi ý. Với mối hàn góc (fillet), kích thước ghi TRƯỚC ký hiệu: chân z (leg) hoặc cổ thiết kế a (throat), với quan hệ a ≈ 0,7z cho mối góc cạnh đều — và chính CỔ mới là tiết diện chịu lực, nên nhầm a với z làm sai khả năng chịu tải. Sau ký hiệu là chiều dài–bước (l–p) cho mối hàn ngắt quãng. Ký hiệu bổ sung: vòng tròn tại giao điểm = hàn vòng quanh (weld all-around), lá cờ = hàn tại công trường (field weld), đường contour = bề mặt phẳng/lồi/lõm.",en:"The numbers around the symbol are MANDATORY requirements, not suggestions. For a fillet weld the size goes BEFORE the symbol: leg z or design throat a, with a ≈ 0.7z for an equal-leg fillet — and it is the THROAT that carries the load, so confusing a with z mis-sizes the load capacity. After the symbol comes length–pitch (l–p) for intermittent welds. Supplementary symbols: a circle at the junction = weld all-around, a flag = field weld, a contour line = flat/convex/concave surface."},
    {vi:"Thanh tra coi bản vẽ là 'hợp đồng kỹ thuật'. Quy trình đọc: từ ký hiệu suy ra loại mối hàn, kích thước, mặt hàn và quá trình (ở đuôi) → đối chiếu với WPS áp dụng → rồi đối chiếu với mối hàn thực tế. Bất kỳ sai lệch nào giữa BA thứ này (bản vẽ ≠ WPS ≠ thực tế) đều phải nêu TRƯỚC khi hàn, vì sau khi hàn việc sửa tốn kém và đôi khi không thể. Đây là nơi kỹ năng đọc bản vẽ trực tiếp ngăn ngừa lỗi tốn tiền.",en:"The inspector treats the drawing as a 'technical contract'. The reading routine: from the symbol derive weld type, size, face and process (in the tail) → cross-check against the applicable WPS → then against the actual weld. Any mismatch among these THREE (drawing ≠ WPS ≠ reality) must be raised BEFORE welding, because afterwards repair is costly and sometimes impossible. This is where drawing-reading skill directly prevents expensive errors."},
   ],
   table:{
    cols:[{vi:"Quy ước",en:"Convention"},{vi:"ISO 2553",en:"ISO 2553"},{vi:"AWS A2.4",en:"AWS A2.4"}],
    data:[
     [{vi:"Mặt mũi tên (arrow side)",en:"Arrow side"},{vi:"Ký hiệu trên đường LIỀN",en:"Symbol on the SOLID line"},{vi:"Ký hiệu DƯỚI đường tham chiếu",en:"Symbol BELOW the reference line"}],
     [{vi:"Mặt kia (other side)",en:"Other side"},{vi:"Ký hiệu trên đường ĐỨT NÉT",en:"Symbol on the DASHED line"},{vi:"Ký hiệu TRÊN đường tham chiếu",en:"Symbol ABOVE the reference line"}],
     [{vi:"Số đường tham chiếu",en:"Reference lines"},{vi:"2 (liền + đứt nét)",en:"2 (solid + dashed)"},{vi:"1 (một đường)",en:"1 (single line)"}],
    ]},
   foot:{vi:"Luôn xác định hệ ký hiệu (ISO hay AWS) TRƯỚC khi đọc; nhầm hệ = hàn nhầm mặt. Nhớ: cổ a chịu lực, a ≈ 0,7z.",en:"Always establish the system (ISO or AWS) BEFORE reading; the wrong system = the wrong face welded. Remember: throat a carries the load, a ≈ 0.7z."}},
 ],
 quiz:[
 ...
 deep:[
  {h_vi:"Nứt nguội do hydro — phân tích cơ chế đầy đủ",h_en:"Hydrogen (cold) cracking — full mechanism analysis",
   body:[
    ...
    {vi:"Bốn yếu tố và logic phá vỡ: nứt chỉ xảy ra khi ĐỒNG THỜI đủ (1) hydro khuếch tán cao, (2) tổ chức nhạy/độ cứng ≥ ~350 HV, (3) ứng suất kéo, (4) nhiệt độ thấp. Về lý thuyết chỉ cần loại bỏ MỘT yếu tố là chặn được nứt, nhưng thực tế ta tấn công nhiều yếu tố cùng lúc: que basic sấy đúng làm giảm hydro; tiền nhiệt và kiểm soát nhiệt đầu vào kéo dài thời gian nguội (t8/5) → vừa làm mềm HAZ (giảm yếu tố 2) vừa cho hydro thoát ra (giảm yếu tố 1); thiết kế mối nối và trình tự hàn giảm kẹp chặt (giảm yếu tố 3); giữ ấm sau hàn ('hydrogen soak') cho hydro khuếch tán hết trước khi nguội hẳn.",en:"The four factors and how to break them: cracking needs ALL of (1) high diffusible hydrogen, (2) susceptible microstructure / hardness ≥ ~350 HV, (3) tensile stress, (4) low temperature. In theory removing ONE factor prevents it, but in practice we attack several at once: correctly baked basic electrodes cut hydrogen; preheat and heat-input control lengthen the cooling time (t8/5), which both softens the HAZ (factor 2) and lets hydrogen escape (factor 1); joint design and welding sequence reduce restraint (factor 3); post-weld holding (a 'hydrogen soak') lets hydrogen diffuse out before the joint goes fully cold."},
    {vi:"Định lượng — CEV, tiền nhiệt, nhiệt đầu vào: khả năng tôi cứng của thép đo bằng Carbon tương đương CEV = C + Mn/6 + (Cr+Mo+V)/5 + (Ni+Cu)/15. CEV càng cao thì HAZ càng dễ hóa martensite → cần tiền nhiệt càng cao. Tiền nhiệt làm chậm tốc độ nguội (tăng t8/5) cho tổ chức mềm hơn và hydro thoát ra; nhiệt đầu vào Heat Input = (U×I×60)/(tốc độ hàn×1000) kJ/mm cũng làm chậm nguội. Thanh tra dùng CEV + chiều dày tổ hợp (combined thickness) + mức hydro của que để tra bảng tiền nhiệt trong EN 1011-2 hoặc AWS D1.1 — đây là 'con số' mà công việc thật sự dùng.",en:"Quantified — CEV, preheat, heat input: a steel's hardenability is measured by carbon equivalent CEV = C + Mn/6 + (Cr+Mo+V)/5 + (Ni+Cu)/15. Higher CEV means the HAZ turns martensitic more readily → more preheat is needed. Preheat slows the cooling rate (raises t8/5) for a softer structure and lets hydrogen out; heat input = (U×I×60)/(travel speed×1000) kJ/mm also slows cooling. The inspector uses CEV + combined thickness + the electrode's hydrogen level to read preheat from EN 1011-2 or AWS D1.1 — these are the actual numbers the job runs on."},
    {vi:"Chẩn đoán của thanh tra: nứt hydro thường nằm ở HAZ tại ngón chân (toe) hoặc dưới cap, dọc theo HAZ; vết mảnh, đôi khi dưới bề mặt nên cần MT/UT chứ không chỉ mắt thường. Vì là nứt trễ, không nghiệm thu vội. Khi gặp nứt HAZ trên thép CEV cao mà hồ sơ cho thấy KHÔNG tiền nhiệt, que không sấy hoặc mối bị kẹp chặt — gần như chắc chắn là nứt hydro, và biện pháp là sửa CỘNG VỚI điều chỉnh quy trình (tiền nhiệt/que), không chỉ mài bỏ.",en:"Inspector diagnosis: hydrogen cracks usually sit in the HAZ at the toe or under the cap, running along the HAZ; they are fine and sometimes sub-surface, so MT/UT — not just the eye — is needed. Being delayed, do not sign off early. When a HAZ crack appears on a high-CEV steel and the records show NO preheat, unbaked rods or a heavily restrained joint, it is almost certainly hydrogen cracking, and the fix is repair PLUS a procedure change (preheat/consumable), not merely grinding it out."},
   ]},
  {h_vi:"Phân biệt 4 họ nứt — phân tích so sánh",h_en:"The four crack families — comparative analysis",
   body:[
    {vi:"Thanh tra phải phân biệt được nguồn gốc bốn họ nứt, vì cách phòng và sửa hoàn toàn khác nhau — nhầm họ nứt dẫn tới biện pháp sai và nứt tái diễn. Phân biệt dựa trên ba trục: VỊ TRÍ (trong kim loại mối hàn hay trong vật liệu nền), THỜI ĐIỂM (lúc đông đặc, lúc nguội, hay khi xử lý nhiệt/vận hành), và TÁC NHÂN luyện kim (lưu huỳnh, hydro, tạp chất MnS, hay hạt thô).",en:"The inspector must identify which of the four crack families is involved, because prevention and repair differ completely — misdiagnosing the family leads to the wrong fix and repeat cracking. Tell them apart on three axes: LOCATION (in the weld metal or the parent), TIMING (on solidification, on cooling, or during heat treatment/service), and the metallurgical AGENT (sulphur, hydrogen, MnS inclusions, or coarse grain)."},
   ],
   table:{
    cols:[{vi:"Họ nứt",en:"Crack family"},{vi:"Vị trí",en:"Location"},{vi:"Thời điểm",en:"Timing"},{vi:"Tác nhân & cách phòng",en:"Agent & prevention"}],
    data:[
     [{vi:"Nứt nóng (đông đặc)",en:"Hot (solidification)"},{vi:"Giữa tâm mối hàn",en:"Weld centreline"},{vi:"Lúc đông đặc (nóng)",en:"On solidifying (hot)"},{vi:"S, P (màng FeS); tỷ lệ sâu/rộng lớn → thép sạch, đủ Mn, giảm dòng, bead hợp lý",en:"S, P (FeS films); high depth/width → clean steel, adequate Mn, lower current, correct bead"}],
     [{vi:"Nứt nguội (hydro/HAZ)",en:"Cold (hydrogen/HAZ)"},{vi:"HAZ (đôi khi mối hàn)",en:"HAZ (sometimes weld)"},{vi:"Trễ, <300°C, tới 72h",en:"Delayed, <300°C, up to 72 h"},{vi:"H + martensite + ứng suất → que ít H, tiền nhiệt, kiểm soát nhiệt, giảm kẹp",en:"H + martensite + stress → low-H rods, preheat, heat control, less restraint"}],
     [{vi:"Rách lớp (lamellar)",en:"Lamellar tearing"},{vi:"Vật liệu nền dưới mối, bậc thang",en:"Parent below weld, step-like"},{vi:"Khi/sau hàn, dưới ứng suất chiều dày",en:"During/after welding, through-thickness strain"},{vi:"MnS dạng dải + co ngót theo chiều dày → thép Z, buttering, đổi thiết kế",en:"Planar MnS + through-thickness shrinkage → Z-grade steel, buttering, redesign"}],
     [{vi:"Nứt tái nung (reheat)",en:"Reheat cracking"},{vi:"HAZ hạt thô",en:"Coarse-grained HAZ"},{vi:"Khi PWHT / vận hành nhiệt cao",en:"During PWHT / high-temp service"},{vi:"Thép Cr-Mo-V, tiết pha biên hạt → mài chân, kiểm soát hạt, quy trình PWHT đúng",en:"Cr-Mo-V steels, boundary precipitation → toe grinding, grain control, correct PWHT"}],
    ]},
   foot:{vi:"Mẹo nhớ tác nhân: Nóng = lưu huỳnh (S) · Nguội = Hydro (H) · Rách lớp = MnS theo chiều dày · Tái nung = Cr-Mo-V khi PWHT.",en:"Agent memory hook: Hot = Sulphur · Cold = Hydrogen · Lamellar = MnS through-thickness · Reheat = Cr-Mo-V during PWHT."}},
  {h_vi:"Khuyết tật phẳng vs khối — vì sao mức nghiêm trọng khác nhau",h_en:"Planar vs volumetric — why severity differs",
   body:[
    {vi:"Không phải khuyết tật nào cũng nguy hiểm như nhau. Khuyết tật PHẲNG (planar: nứt, thiếu ngấu, thiếu thấu) có đầu nhọn sắc → hệ số tập trung ứng suất rất cao → là điểm khởi phát nứt mỏi và phá hủy giòn. Khuyết tật KHỐI (volumetric: rỗ khí, ngậm xỉ tròn) có dạng bo tròn → tập trung ứng suất thấp hơn nhiều → thường được dung sai theo một mức phần trăm diện tích/chiều dài. Vì vậy hầu hết tiêu chuẩn nghiệm thu CẤM tuyệt đối nứt và thiếu ngấu, nhưng CHO PHÉP một mức rỗ/xỉ nhất định — đây là logic đằng sau bảng tiêu chí, không phải con số tùy tiện.",en:"Not all defects are equally dangerous. PLANAR defects (cracks, lack of fusion, lack of penetration) have sharp tips → very high stress concentration → they are initiation sites for fatigue and brittle fracture. VOLUMETRIC defects (rounded porosity, globular slag) are blunt → far lower stress concentration → they are usually tolerated up to a percent-of-area/length limit. So most acceptance standards forbid cracks and lack of fusion outright but ALLOW a defined level of porosity/slag — that is the logic behind the criteria tables, not arbitrary numbers."},
    {vi:"Hai triết lý nghiệm thu: 'workmanship' (tay nghề — vd ISO 5817 mức B/C/D) giới hạn theo loại và kích thước khuyết tật, đơn giản và dùng cho chế tạo chung. 'Fitness-for-service' / ECA (vd BS 7910) tính toán xem một khuyết tật cụ thể có chịu được tải tĩnh và tải mỏi trong suốt tuổi thọ không — đôi khi cho giữ lại khuyết tật mà workmanship loại bỏ, nhưng phải có kỹ sư phân tích. Thanh tra cần biết hồ sơ áp dụng tiêu chí nào và KHÔNG được tự ý nới lỏng.",en:"Two acceptance philosophies: 'workmanship' (e.g. ISO 5817 levels B/C/D) limits defects by type and size — simple, for general fabrication. 'Fitness-for-service' / ECA (e.g. BS 7910) calculates whether a specific flaw will survive static and fatigue loading over the design life — sometimes allowing flaws that workmanship would reject, but only with an engineer's analysis. The inspector must know which criterion the contract uses and must NOT relax it unilaterally."},
    {vi:"Hệ quả mỏi của khuyết tật bề mặt: cháy chân (undercut), chân khía sắc, lệch mép (hi-lo) và chảy tràn (overlap) đều tạo điểm tập trung ứng suất ở bề mặt → giảm mạnh tuổi thọ mỏi dù tiết diện vẫn đủ chịu tải TĨNH. Với kết cấu chịu tải ĐỘNG (cầu, giàn khoan, cần cẩu) các khuyết tật hình dạng này quan trọng hơn nhiều so với kết cấu tĩnh — vì thế cùng một undercut có thể 'đạt' ở bồn chứa tĩnh nhưng 'loại' ở chi tiết chịu mỏi.",en:"Fatigue impact of surface defects: undercut, sharp toe angles, hi-lo misalignment and overlap all create surface stress raisers → they sharply cut fatigue life even when the section still carries the STATIC load. For DYNAMICALLY loaded structures (bridges, rigs, cranes) these profile defects matter far more than for static ones — so the same undercut may 'pass' on a static tank but 'fail' on a fatigue-loaded member."},
   ]},
  {h_vi:"Tư duy phân tích nguyên nhân gốc (RCA)",h_en:"Root-cause analysis thinking",
   body:[
    {vi:"Khi một khuyết tật lặp lại, thanh tra giỏi không chỉ loại bỏ mà truy nguyên nhân để chặn tái diễn. Quy trình bốn bước: (1) Nhận dạng đúng loại và vị trí (kết hợp RT/UT/MT/PT). (2) Suy ngược về tác nhân vật lý: rỗ → khí kẹt (ẩm, bẩn, mất khí, gió); xỉ → làm sạch lớp kém, dòng thấp, rãnh quá hẹp; thiếu ngấu → nhiệt thiếu, góc sai, tốc độ nhanh; nứt → xác định họ nứt như phần trên. (3) Đối chiếu WPS với thực tế: dòng, áp, tốc độ, tiền nhiệt, lưu lượng khí có đúng không. (4) Đề xuất khắc phục và phòng ngừa, lập NCR.",en:"When a defect recurs, a good inspector does not just remove it — they trace the cause to stop repeats. A four-step routine: (1) identify type and location correctly (combine RT/UT/MT/PT). (2) reason back to the physical agent: porosity → trapped gas (moisture, dirt, lost shielding, wind); slag → poor interpass cleaning, low current, too-narrow groove; lack of fusion → too little heat, wrong angle, fast travel; cracks → determine the family as above. (3) compare the WPS with reality: current, voltage, travel, preheat, gas flow. (4) propose correction and prevention, raise an NCR."},
    {vi:"Ví dụ phân tích: rỗ khí dạng cụm xuất hiện đúng tại điểm mồi lại trên mối MAG hàn ngoài trời. Suy luận: mất khí bảo vệ do gió, kèm khả năng ẩm/oxide tại điểm dừng. Khắc phục: dựng chắn gió hoặc đổi sang FCAW tự bảo vệ, cải thiện kỹ thuật nối đường hàn, kiểm tra lưu lượng và rò rỉ ống khí. Chính chuỗi 'hiện tượng → cơ chế → thông số → hành động' này là chiều sâu mà công việc thật cần, và là điều tạo nên giá trị tư vấn của một thanh tra/kỹ sư hàn.",en:"Worked example: cluster porosity appears exactly at re-start points on a MAG weld run outdoors. Reasoning: shielding loss from wind, plus likely moisture/oxide at the stops. Fix: erect wind screens or switch to self-shielded FCAW, improve the tie-in technique, check gas flow and hose leaks. This 'symptom → mechanism → parameter → action' chain is the depth the real job needs, and it is what makes a welding inspector/engineer's advice valuable."},
   ],
   foot:{vi:"Mục tiêu nghề: không dừng ở 'đạt/không đạt' mà hiểu CƠ CHẾ để tư vấn phòng ngừa — đây là phần khó sao chép và có giá trị thương mại.",en:"Professional aim: go beyond 'accept/reject' to understand the MECHANISM and advise on prevention — the hard-to-copy, commercially valuable part."}},
 ],
 quiz:[
...
{vi:"Kiểm tra phá hủy (DT)", en:"Destructive Testing",
 ...
 deep:[
  {h_vi:"DT đo cơ tính — nền tảng của PQR & qualify thợ",h_en:"DT measures properties — the basis of PQR & qualification",
   body:[
    {vi:"Khác với NDT (đi tìm khuyết tật), thử phá hủy đo CƠ TÍNH THỰC của mối hàn — bền kéo, độ dẻo, độ dai, độ cứng — những thứ NDT không thể cho biết. Vì phải cắt-phá mẫu nên DT KHÔNG dùng cho sản phẩm thật, mà dùng để CHỨNG MINH một quy trình hàn (PQR) hoặc một thợ hàn tạo ra mối hàn đạt yêu cầu. Nói cách khác: NDT trả lời 'mối hàn này có khuyết tật không?', còn DT trả lời 'kiểu hàn này có đủ bền và dai để chịu tải không?'.",en:"Unlike NDT (which hunts for defects), destructive testing measures the weld's REAL mechanical properties — tensile strength, ductility, toughness, hardness — things NDT cannot reveal. Because the coupon is cut and broken, DT is NOT used on production parts but to PROVE that a welding procedure (PQR) or a welder produces a sound, adequate weld. Put simply: NDT answers 'does this weld have a defect?', while DT answers 'is this type of weld strong and tough enough to carry load?'."},
    {vi:"Mỗi phép thử trả lời một câu hỏi riêng. Thử KÉO đo bền kéo và cho biết mối hàn đứt ở đâu — đạt khi đứt ngoài mối hàn hoặc đạt bền tối thiểu của kim loại nền (mối hàn không yếu hơn nền). Thử UỐN (mặt/chân/cạnh) kiểm tra độ dẻo và chất lượng ngấu — nứt khi uốn lộ ra thiếu ngấu hoặc tổ chức giòn. Thử VA ĐẬP Charpy đo độ dai theo Joule ở nhiệt độ vận hành (vd 27J ở -20°C), lấy mẫu cả ở mối hàn và HAZ — quan trọng để chống phá hủy giòn ở thép làm việc lạnh. Thử ĐỘ CỨNG (Vickers HV) lập bản đồ độ cứng qua nền–HAZ–mối hàn: HV cao báo hiệu tổ chức cứng giòn và rủi ro nứt hydro.",en:"Each test answers its own question. The TENSILE test measures strength and shows where it breaks — it passes when fracture is outside the weld or meets the base metal minimum (the weld is not weaker than the parent). The BEND test (face/root/side) checks ductility and fusion quality — cracking on bending exposes lack of fusion or brittleness. The CHARPY impact test measures toughness in joules at the service temperature (e.g. 27 J at -20°C), with specimens in both weld and HAZ — vital against brittle fracture in cold-service steel. The HARDNESS test (Vickers HV) maps hardness across parent–HAZ–weld: high HV signals a hard, brittle structure and hydrogen-cracking risk."},
    {vi:"DT là trái tim của PQR và qualify thợ — phần 'khó sao chép, thương mại được'. Khi lập PQR, ta hàn một tấm mẫu theo pWPS rồi cắt mẫu đem thử kéo, uốn, và (khi code yêu cầu) va đập + độ cứng; nếu kết quả đạt thì quy trình mới được phê duyệt thành WPS. Qualify THỢ thường nhẹ hơn — chủ yếu thử uốn (hoặc chụp RT) để chứng minh tay nghề tạo mối hàn lành lặn. Hiểu rõ phép thử nào bắt buộc cho trường hợp nào chính là kiến thức tạo ra dịch vụ tư vấn quy trình.",en:"DT is the heart of the PQR and welder qualification — the 'hard-to-copy, commercial' part. To build a PQR, a test plate is welded to a pWPS, then coupons are cut for tensile, bend and (where the code requires) impact + hardness; only if they pass is the procedure approved as a WPS. WELDER qualification is usually lighter — mainly bend tests (or RT) to prove the operator makes sound welds. Knowing exactly which test is mandatory in which case is the knowledge that becomes a procedure-consulting service."},
    {vi:"Vai trò thanh tra với DT: chứng kiến việc lấy mẫu đúng vị trí và đúng số lượng theo code, gửi mẫu tới phòng thí nghiệm được công nhận, kiểm tra máy thử còn hiệu chuẩn, rồi đọc và lưu báo cáo — đối chiếu từng con số với tiêu chí của code (vd giới hạn độ cứng 350 HV cho thép thường, hay ≤ 248 HV cho môi trường chua theo NACE/ISO 15156). Thanh tra không tự diễn giải 'đạt' theo cảm tính mà dựa vào ngưỡng định lượng.",en:"The inspector's role in DT: witness that coupons are taken at the right locations and in the right number per the code, send them to an accredited lab, check the testing machine calibration, then read and file the report — comparing each number to the code criteria (e.g. a 350 HV hardness limit for ordinary steel, or ≤ 248 HV for sour service per NACE/ISO 15156). The inspector does not judge 'pass' by feel but against quantitative thresholds."},
   ],
   table:{
    cols:[{vi:"Phép thử",en:"Test"},{vi:"Đo cái gì",en:"Measures"},{vi:"Đạt khi",en:"Passes when"}],
    data:[
     [{vi:"Kéo (tensile)",en:"Tensile"},{vi:"Bền kéo, vị trí đứt",en:"Strength, break location"},{vi:"≥ bền tối thiểu của nền; đứt ngoài mối hàn",en:"≥ base-metal minimum; breaks outside the weld"}],
     [{vi:"Uốn (bend)",en:"Bend"},{vi:"Độ dẻo, chất lượng ngấu",en:"Ductility, fusion quality"},{vi:"Không nứt quá giới hạn (vd >3mm)",en:"No crack beyond the limit (e.g. >3mm)"}],
     [{vi:"Va đập (Charpy)",en:"Charpy impact"},{vi:"Độ dai ở nhiệt độ vận hành",en:"Toughness at service temp"},{vi:"≥ giá trị J yêu cầu ở nhiệt độ thử",en:"≥ required J at the test temperature"}],
     [{vi:"Độ cứng (HV)",en:"Hardness (HV)"},{vi:"Độ cứng nền–HAZ–mối hàn",en:"Hardness parent–HAZ–weld"},{vi:"≤ giới hạn (vd 350 HV; 248 HV chua)",en:"≤ limit (e.g. 350 HV; 248 HV sour)"}],
     [{vi:"Macro/Micro",en:"Macro/Micro"},{vi:"Mặt cắt: ngấu, lớp, khuyết tật",en:"Section: fusion, passes, defects"},{vi:"Không khuyết tật quá tiêu chuẩn",en:"No defect beyond the standard"}],
    ]},
   foot:{vi:"DT chứng minh CƠ TÍNH (không phải tìm khuyết tật) → là nền tảng của PQR & qualify thợ — dịch vụ kỹ thuật giá trị cao.",en:"DT proves PROPERTIES (not defect-finding) → the basis of the PQR & welder qualification — a high-value technical service."}},
 ],
 quiz:[
 ...
 deep:[
  {h_vi:"Chọn phương pháp NDT — logic theo loại khuyết tật",h_en:"Choosing an NDT method — logic by defect type",
   body:[
    ...
    {vi:"Mỗi phương pháp có nguyên lý và giới hạn riêng. VT (mắt thường) rẻ và luôn làm đầu tiên, bắt khuyết tật bề mặt và sai hình dạng nhưng cần ánh sáng, thước, dưỡng. PT (thẩm thấu) dùng cho MỌI vật liệu không xốp nhưng chỉ thấy khuyết tật HỞ RA bề mặt. MT (từ tính) chỉ dùng cho vật liệu SẮT TỪ (không dùng cho inox austenit hay nhôm) và phải từ hóa VUÔNG GÓC với khuyết tật mới hiện. RT (chụp tia) cho ảnh lưu làm bằng chứng, rất tốt với khuyết tật KHỐI, nhưng KÉM với nứt phẳng nếu tia không song song vết nứt, lại có rủi ro bức xạ. UT (siêu âm) nhạy với khuyết tật PHẲNG và đo được chiều sâu/vị trí, không bức xạ, nhưng phụ thuộc tay nghề và truyền thống khó lưu ảnh trực quan.",en:"Each method has its own principle and limits. VT (visual) is cheap and always first, catching surface and profile defects but needing light, gauges and templates. PT (penetrant) works on ANY non-porous material but only shows flaws OPEN to the surface. MT (magnetic) works only on FERROMAGNETIC material (not austenitic stainless or aluminium) and must be magnetised PERPENDICULAR to the flaw to reveal it. RT (radiography) gives a permanent image as evidence and excels at VOLUMETRIC flaws, but is WEAK on planar cracks unless the beam aligns with them, and carries a radiation hazard. UT (ultrasonic) is sensitive to PLANAR flaws and measures depth/position, with no radiation, but depends on operator skill and traditionally leaves no visual record."},
    {vi:"So sánh RT và UT là quyết định kinh điển. RT thấy rõ khối và để lại phim/ảnh số làm bằng chứng khách quan, nhưng yếu với nứt mảnh và đòi hỏi kiểm soát vùng bức xạ cùng thời gian phơi. UT nhạy hơn với nứt phẳng và thiếu ngấu thành, đo được độ sâu để đánh giá fitness-for-service, không bức xạ — nhưng phụ thuộc kỹ năng người đọc. Các kỹ thuật số hiện đại PAUT (phased array) và TOFD khắc phục điểm yếu lưu ảnh của UT, nên ngày càng nhiều code cho phép UT/PAUT thay RT, nhất là cho thép dày.",en:"Comparing RT and UT is a classic decision. RT shows volume clearly and leaves a film/digital image as objective evidence, but is weak on tight cracks and needs radiation-area control plus exposure time. UT is more sensitive to planar cracks and sidewall lack of fusion, measures depth for fitness-for-service assessment, and has no radiation — but depends on the reader's skill. Modern digital techniques PAUT (phased array) and TOFD overcome UT's record-keeping weakness, so more codes now allow UT/PAUT in place of RT, especially on thick steel."},
    {vi:"Vai trò thanh tra: chọn đúng phương pháp theo khuyết tật nghi ngờ và theo code, kiểm tra chứng chỉ kỹ thuật viên NDT (PCN hoặc SNT-TC-1A, thường yêu cầu Level II để diễn giải), canh THỜI ĐIỂM thử (với thép nhạy nứt nguội phải đợi 48–72 giờ vì nứt hydro xuất hiện trễ), rồi đọc và đối chiếu báo cáo với tiêu chí chấp nhận của code. Với RT, thanh tra còn phải đảm bảo an toàn bức xạ cho khu vực.",en:"The inspector's role: pick the right method for the suspected flaw and the code, check the NDT technician's certification (PCN or SNT-TC-1A, usually Level II to interpret), time the test correctly (on crack-sensitive steel, wait 48–72 h because hydrogen cracks appear late), then read and compare the report to the code's acceptance criteria. For RT, the inspector also ensures radiation safety for the area."},
   ],
   table:{
    cols:[{vi:"Phương pháp",en:"Method"},{vi:"Bắt khuyết tật",en:"Detects"},{vi:"Vật liệu",en:"Material"},{vi:"Hạn chế",en:"Limitation"}],
    data:[
     [{vi:"VT",en:"VT"},{vi:"Bề mặt, hình dạng",en:"Surface, profile"},{vi:"Mọi",en:"Any"},{vi:"Chỉ thấy bằng mắt",en:"Visible only"}],
     [{vi:"PT",en:"PT"},{vi:"Hở ra bề mặt",en:"Surface-breaking"},{vi:"Mọi (không xốp)",en:"Any (non-porous)"},{vi:"Không thấy dưới bề mặt",en:"Nothing sub-surface"}],
     [{vi:"MT",en:"MT"},{vi:"Bề mặt & cận bề mặt",en:"Surface & near-surface"},{vi:"Chỉ sắt từ",en:"Ferromagnetic only"},{vi:"Không cho inox/nhôm",en:"Not stainless/aluminium"}],
     [{vi:"RT",en:"RT"},{vi:"Khối (rỗ, xỉ)",en:"Volumetric (porosity, slag)"},{vi:"Mọi",en:"Any"},{vi:"Kém với nứt phẳng; bức xạ",en:"Weak on planar; radiation"}],
     [{vi:"UT/PAUT",en:"UT/PAUT"},{vi:"Phẳng (nứt), đo sâu",en:"Planar (cracks), depth"},{vi:"Kim loại",en:"Metals"},{vi:"Phụ thuộc tay nghề",en:"Skill-dependent"}],
    ]},
   foot:{vi:"Nguyên tắc: bề mặt → VT/PT/MT; thể tích → RT/UT; nứt phẳng → ưu tiên UT; cần bằng chứng ảnh → RT. Luôn chọn theo khuyết tật + code.",en:"Rule: surface → VT/PT/MT; volume → RT/UT; planar cracks → prefer UT; image evidence → RT. Always choose by flaw + code."}},
 ],
 quiz:[
...
{vi:"WPS / PQR / Chứng nhận thợ hàn", en:"WPS / PQR / Welder Qualification",
 ...
 deep:[
  {h_vi:"pWPS → PQR → WPS: xương sống kiểm soát chất lượng hàn",h_en:"pWPS → PQR → WPS: the backbone of weld quality control",
   body:[
    {vi:"Ba tài liệu liên kết theo một logic chặt. pWPS (WPS sơ bộ) là bản DỰ KIẾN các thông số hàn. Ta hàn một tấm mẫu theo pWPS, rồi cắt mẫu thử phá hủy; mọi kết quả ghi vào PQR — bằng chứng KHÔNG SỬA ĐƯỢC rằng kiểu hàn đó cho cơ tính đạt. Cuối cùng WPS (đã phê duyệt) được viết RA TỪ PQR, có dải thông số cho thợ dùng khi sản xuất. Nguyên tắc bất biến: một WPS chỉ hợp lệ khi có PQR chống lưng; không có PQR đạt thì WPS chỉ là tờ giấy.",en:"Three documents linked by a strict logic. The pWPS (preliminary WPS) is the PROPOSED set of welding parameters. A test plate is welded to the pWPS, then coupons are destructively tested; all results are recorded in the PQR — an UNALTERABLE record that this type of weld gives adequate properties. Finally the approved WPS is written FROM the PQR, with parameter ranges for welders to use in production. The unbreakable rule: a WPS is valid only when a PQR backs it; without a passing PQR, a WPS is just paper."},
    {vi:"Biến số THIẾT YẾU (essential variables) là khái niệm cốt lõi và là câu hỏi thi kinh điển. Đó là những thông số mà nếu thay đổi sẽ làm ĐỔI CƠ TÍNH hoặc tổ chức luyện kim của mối hàn — ví dụ: quá trình hàn, nhóm vật liệu (P-number), nhóm que (F-number/A-number), dải chiều dày, tiền nhiệt, nhiệt đầu vào, xử lý nhiệt sau hàn (PWHT), loại khí. Thay đổi một biến thiết yếu ra ngoài dải đã chứng minh → BẮT BUỘC qualify lại bằng PQR mới. Biến KHÔNG thiết yếu chỉ cần sửa trên WPS, không phải qualify lại. Hiểu điều này để biết một WPS phủ được PHẠM VI công việc nào (range of qualification) — kiến thức trực tiếp tạo ra dịch vụ lập quy trình.",en:"ESSENTIAL variables are the core concept and a classic exam question. They are parameters that, if changed, ALTER the weld's mechanical properties or metallurgy — for example: the welding process, material group (P-number), consumable group (F-number/A-number), thickness range, preheat, heat input, post-weld heat treatment (PWHT), gas type. Changing an essential variable outside the proven range → re-qualification with a NEW PQR is MANDATORY. A non-essential variable only needs a WPS edit, not re-qualification. Grasping this tells you the RANGE a WPS covers (range of qualification) — knowledge that directly creates a procedure-writing service."},
    {vi:"Qualify QUY TRÌNH khác qualify THỢ, và lẫn lộn hai cái là sai lầm thường gặp. PQR chứng minh QUY TRÌNH cho cơ tính tốt (kéo, uốn, đôi khi va đập/độ cứng). Chứng chỉ thợ (WPQ) chứng minh CON NGƯỜI có kỹ năng tạo mối hàn lành lặn — thường chỉ thử uốn hoặc chụp RT. Biến thiết yếu của THỢ lại khác: vị trí hàn, đường kính ống, có/không tấm lót (backing), dải chiều dày, nhóm que — chúng quyết định thợ được phép hàn việc gì. Một thợ qualify hàn ống tư thế 6G thường phủ được nhiều vị trí hơn so với qualify 1G tấm bằng.",en:"Qualifying the PROCEDURE differs from qualifying the WELDER, and confusing the two is a common mistake. The PQR proves the PROCEDURE gives good properties (tensile, bend, sometimes impact/hardness). The welder certificate (WPQ) proves the PERSON can make a sound weld — usually only a bend test or RT. The welder's essential variables are different: position, pipe diameter, backing or not, thickness range, consumable group — these decide what the welder may weld. A welder qualified on 6G pipe usually covers more positions than one qualified on 1G flat plate."},
    {vi:"Vai trò thanh tra và giá trị thương mại. Trước khi hàn, thanh tra kiểm: WPS có PQR chống lưng không; thợ có chứng chỉ ĐÚNG PHẠM VI (quá trình, vật liệu, chiều dày, vị trí) và CÒN HIỆU LỰC (thường xác nhận tính liên tục mỗi 6 tháng, giá trị 2–3 năm tùy code); và công việc thực tế nằm trong dải qualify. Đây chính là chuỗi dịch vụ kỹ thuật khó sao chép mà anh nhắm tới: lập pWPS → tổ chức hàn mẫu và thử phá hủy → biên soạn PQR và WPS → tổ chức qualify thợ. Một bộ WPS/PQR đúng chuẩn là tài sản có giá trị lâu dài cho nhà thầu.",en:"The inspector's role and the commercial value. Before welding, the inspector checks: that the WPS is backed by a PQR; that the welder's certificate covers the RIGHT RANGE (process, material, thickness, position) and is STILL VALID (continuity usually confirmed every 6 months, validity 2–3 years depending on the code); and that the actual work falls within the qualified range. This is exactly the hard-to-copy technical service you are aiming at: write the pWPS → run the test weld and destructive tests → compile the PQR and WPS → run welder qualification. A correct set of WPS/PQR is a long-lasting asset for a contractor."},
   ],
   table:{
    cols:[{vi:"Tài liệu",en:"Document"},{vi:"Là gì",en:"What it is"},{vi:"Chứng minh / dùng để",en:"Proves / used for"}],
    data:[
     [{vi:"pWPS",en:"pWPS"},{vi:"Bản nháp thông số dự kiến",en:"Draft proposed parameters"},{vi:"Để hàn mẫu thử",en:"To weld the test coupon"}],
     [{vi:"PQR",en:"PQR"},{vi:"Hồ sơ kết quả thử mẫu (DT)",en:"Record of coupon test (DT) results"},{vi:"Quy trình cho cơ tính đạt",en:"Procedure gives adequate properties"}],
     [{vi:"WPS",en:"WPS"},{vi:"Hướng dẫn hàn đã duyệt (có dải)",en:"Approved welding instruction (with ranges)"},{vi:"Dùng cho sản xuất",en:"Used in production"}],
     [{vi:"WPQ",en:"WPQ"},{vi:"Chứng chỉ tay nghề thợ",en:"Welder qualification record"},{vi:"Người hàn được mối lành lặn",en:"The person makes sound welds"}],
    ]},
   foot:{vi:"WPS phải có PQR chống lưng; đổi biến thiết yếu = qualify lại. Lập PQR/WPS & qualify thợ = dịch vụ kỹ thuật giá trị cao, khó sao chép.",en:"A WPS must be backed by a PQR; changing an essential variable = re-qualify. Writing PQRs/WPSs & qualifying welders = a high-value, hard-to-copy technical service."}},
 ],
 quiz:[
